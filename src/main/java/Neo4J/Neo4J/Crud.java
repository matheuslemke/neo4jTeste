...
public class Crud {
	...
	public long getIdNodes(String propertyUnique, String value, String nodeName) {
		...
		result = connector.db.execute("MATCH (n:" + nodeName + " {" + propertyUnique + ":" +"'" +value +"\'" + " } ) RETURN ID(n)");
	...
	public void creationRelationship(RelationshipType relationship, long node1, long node2) {
